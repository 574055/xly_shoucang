...
void rfidInit(int set)
{

  {
    ...
    switch (set)
    {
    case 0: {byte setPower1[] = {0xBB, 0x00, 0xB6, 0x00, 0x02, 0x0A, 0x28, 0xEA, 0x7E};Serial2.write(setPower1, sizeof(setPower1));break;}// 26dBm 
    case 1: {byte setPower2[] = {0xBB, 0x00, 0xB6, 0x00, 0x02, 0x07, 0xD0, 0x8F, 0x7E};Serial2.write(setPower2, sizeof(setPower2));break;} //20dBm
    case 2: {byte setPower3[] = {0xBB, 0x00, 0xB6, 0x00, 0x02, 0x07, 0x3A, 0xF9, 0x7E};Serial2.write(setPower3, sizeof(setPower3));break;}//18.5dBm
    case 3: {byte setPower4[] = {0xBB, 0x00, 0xB6, 0x00, 0x02, 0x06, 0x0E, 0xCC, 0x7E};Serial2.write(setPower4, sizeof(setPower4));break;} //15.5dBm

    default: {byte setPower5[] = {0xBB, 0x00, 0xB6, 0x00, 0x02, 0x0A, 0x28, 0xEA, 0x7E};Serial2.write(setPower5, sizeof(setPower5));}// 26dBm 
...
void rfidread()
{
  ...
  delay(100);
  numberOfTags1 = finalTags1.length() / 8;
  // Serial.print((String)"Found1:" + finalTags1+'\t');
  // Serial.print((String)"Number1:" + numberOfTags1+'\t');
  

  finalTags2 = multiscan2_v2(&numberOfTags2, TIMEOUT);
  delay(100);
  numberOfTags2 = finalTags2.length() / 8;
  // Serial.print((String)"Found2:" + finalTags2+'\t');
  // Serial.print((String)"Number2:" + numberOfTags2+'\t');

  finalTags = keepIndividuals(finalTags1, numberOfTags1, finalTags2, numberOfTags2);
  numberOfTags = finalTags.length() / 8;
  ...
  addedTags = tagsChanged(prev_finalTags, prev_numberOfTags, finalTags, numberOfTags);
  removedTags = tagsChanged(finalTags, numberOfTags, prev_finalTags, prev_numberOfTags);
