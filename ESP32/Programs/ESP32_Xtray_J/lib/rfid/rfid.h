...
public:
    ...
    // Perform an RFID scan. Data is inserted into tagset.
    void scan(etl::unordered_set<RFIDData, RFID_MULTISCAN_AMOUNT>& tagset, uint32_t timeout);
