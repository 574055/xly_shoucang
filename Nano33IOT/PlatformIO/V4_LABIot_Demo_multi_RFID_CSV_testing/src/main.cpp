...
void loop() {
  ...
  debugln("TOTAL:");
  Serial.print((String)weight + "\t"); //send weight to GUI
  Serial.print((String)numberOfTags +"\t"); //send numberOfTags to GUI
  Serial.println((String)finalTags); //send finalTags to GUI
