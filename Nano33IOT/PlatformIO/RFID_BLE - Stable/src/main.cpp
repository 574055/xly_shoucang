...
void loop() {
  ...
  //{ 
    BLE.stopAdvertise();
    if(prev_finalTags!=finalTags1 || prev_numberOfTags!=numberOfTags){
    TagsDataCharacteristic.writeValue(finalTags1);
    NumbersOfTagsCharacteristic.writeValue(numberOfTags1);
    }
